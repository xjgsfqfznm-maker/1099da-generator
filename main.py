...
RATE LIMITING: 25 requests per IP per hour via flask-limiter
"""
import json
import logging
import os
...
def rate_limited(e):
    return jsonify({"error": "Rate limit exceeded. Maximum 25 requests per hour per IP."}), 429
